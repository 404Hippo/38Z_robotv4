...
void blueAWP(){
  ...
  pros::delay(500);
  setWallstake(0);
  chassis.pid_swing_set(ez::LEFT_SWING, -55_deg, SWING_SPEED, 47);
  chassis.pid_wait();
  setWallstake(-50);
  ...
  chassis.pid_wait();
  chassis.pid_swing_set(ez::LEFT_SWING, 28_deg, SWING_SPEED, 50);
  chassis.pid_wait();
  clamp1.retract();
  doinker2.extend();
  pros::delay(500);
  ...
  chassis.pid_wait();
  setIntake(127);
  chassis.pid_drive_set(25_in, 65, true);
  chassis.pid_wait();
  pros::delay(500);
  chassis.pid_drive_set(-20_in, DRIVE_SPEED, true);
  chassis.pid_wait();
...
void redAWP(){
  ...
  pros::delay(500);
  setWallstake(0);
  chassis.pid_swing_set(ez::RIGHT_SWING, 55_deg, SWING_SPEED, 47);
  chassis.pid_wait();
  setWallstake(-50);
  chassis.pid_drive_set(-5_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(53_deg, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_swing_set(ez::RIGHT_SWING, -28_deg, SWING_SPEED, 50);
  chassis.pid_wait();
  clamp1.retract();
  doinker.extend();
  pros::delay(500);
...
void blueright(){
  ...
  chassis.pid_wait();
  chassis.pid_swing_set(ez::LEFT_SWING, -90_deg, SWING_SPEED, 52);
  chassis.pid_wait();
  chassis.pid_drive_set(15_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  chassis.pid_swing_set(ez::LEFT_SWING, 180_deg, SWING_SPEED, 40);
  chassis.pid_wait();
...
void redleft(){
  ...
  chassis.pid_turn_set(150_deg, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_swing_set(ez::RIGHT_SWING, 90_deg, SWING_SPEED, 52);
  chassis.pid_wait();
  chassis.pid_drive_set(15_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  chassis.pid_swing_set(ez::RIGHT_SWING, -180_deg, SWING_SPEED, 40);
  chassis.pid_wait();
  chassis.pid_turn_set(100_deg, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_drive_set(15_in, DRIVE_SPEED, true);
